    ...
    <div className="px-4 mx-auto max-w-screen-md">
      ...
      <form action="#" className="space-y-8">
        ...
        <div>
          ...
          <input type="text" id="subject"placeholder="Let us know how can help you" className="form__input mt-1" />
        </div>
        <div>
          <label htmlFor="message" className="form__label">
            Your Message
          </label>
          <textarea type="text" rows={6} id="message"placeholder="leave a comment" className="form__input mt-1" />
        </div>
